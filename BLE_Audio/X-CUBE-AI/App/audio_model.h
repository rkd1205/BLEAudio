...
#define AI_AUDIO_MODEL_IN_1_HEIGHT      (124)
#define AI_AUDIO_MODEL_IN_1_WIDTH       (129)
#define AI_AUDIO_MODEL_IN_1_CHANNEL     (1)
#define AI_AUDIO_MODEL_IN_1_SIZE        (124 * 129 * 1)
#define AI_AUDIO_MODEL_IN_1_SIZE_BYTES  (15996)
...
#define AI_AUDIO_MODEL_OUT_1_CHANNEL     (1)
#define AI_AUDIO_MODEL_OUT_1_SIZE        (1)
#define AI_AUDIO_MODEL_OUT_1_SIZE_BYTES  (1)

/******************************************************************************/
#define AI_AUDIO_MODEL_N_NODES (6)
