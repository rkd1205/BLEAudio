...
AI_ALIGNED(32)
static uint8_t pool0[AI_AUDIO_MODEL_DATA_ACTIVATION_1_SIZE];
...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_AUDIO_MODEL_MODEL_NAME,
        .config = AI_AUDIO_MODEL_DATA_CONFIG,
        .ai_get_report = ai_audio_model_get_report,
        .ai_create = ai_audio_model_create,
        .ai_destroy = ai_audio_model_destroy,
        .ai_get_error = ai_audio_model_get_error,
        .ai_init = ai_audio_model_init,
        .ai_run = ai_audio_model_run,
        .ai_forward = ai_audio_model_forward,
        .ai_data_params_get = ai_audio_model_data_params_get,
        ...
        const ai_buffer* network_config)
{
    ...
    if (network_config == NULL) {
    	//STBOX1_PRINTF("create network for NULL Config\n");
        err = found->ai_create(network, found->config);
    } else {
    	//STBOX1_PRINTF("create network for network_Config\n");
