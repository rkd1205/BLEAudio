...
typedef struct
{
  ...
  int32_t (*GetSensitivity)(LSM6DSV32X_Object_t *, float *);
  int32_t (*GetOutputDataRate)(LSM6DSV32X_Object_t *, float *);
  int32_t (*SetOutputDataRate)(LSM6DSV32X_Object_t *, float);
